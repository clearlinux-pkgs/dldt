...
Version  : 2019.r3
Release  : 65
URL      : https://github.com/opencv/dldt/archive/2019_R3/dldt-2019.R3.tar.gz
Source0  : https://github.com/opencv/dldt/archive/2019_R3/dldt-2019.R3.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1571837077
...
cp %{_builddir}/dldt-2019_R3/LICENSE %{buildroot}/usr/share/package-licenses/dldt/7df059597099bb7dcf25d2a9aedfaf4465f72d8d
cp %{_builddir}/dldt-2019_R3/inference-engine/samples/thirdparty/gflags/COPYING.txt %{buildroot}/usr/share/package-licenses/dldt/b2d4ab17f1b8ef9e0646ba932dce81efe3b852ab
cp %{_builddir}/dldt-2019_R3/inference-engine/tests/libs/gtest/googlemock/LICENSE %{buildroot}/usr/share/package-licenses/dldt/5a2314153eadadc69258a9429104cd11804ea304
cp %{_builddir}/dldt-2019_R3/inference-engine/tests/libs/gtest/googlemock/scripts/generator/LICENSE %{buildroot}/usr/share/package-licenses/dldt/1d4719e04eaa4909ab5a59ef5cb04d2a5517716e
cp %{_builddir}/dldt-2019_R3/inference-engine/tests/libs/gtest/googletest/LICENSE %{buildroot}/usr/share/package-licenses/dldt/5a2314153eadadc69258a9429104cd11804ea304
cp %{_builddir}/dldt-2019_R3/inference-engine/thirdparty/clDNN/common/googletest-fused/License.txt %{buildroot}/usr/share/package-licenses/dldt/9283634b9c14d0b7d238f4219d44a60974bd2030
cp %{_builddir}/dldt-2019_R3/inference-engine/thirdparty/clDNN/common/intel_ocl_icd/6.3/OpenCL_ICD_Loader_License.txt %{buildroot}/usr/share/package-licenses/dldt/db214a78d03be892d25086bc555baacf3bdf153b
cp %{_builddir}/dldt-2019_R3/inference-engine/thirdparty/clDNN/common/intel_ocl_icd/6.3/OpenCL_headers_License.txt %{buildroot}/usr/share/package-licenses/dldt/009a9705ecc0db197274c321509be5bdacd6b9e1
cp %{_builddir}/dldt-2019_R3/inference-engine/thirdparty/clDNN/common/khronos_ocl_clhpp/LICENSE.txt %{buildroot}/usr/share/package-licenses/dldt/69ad187528313b14f3320f102227ce17d68436be
cp %{_builddir}/dldt-2019_R3/inference-engine/thirdparty/mkl-dnn/LICENSE %{buildroot}/usr/share/package-licenses/dldt/b62656e08adcf16ce153c1df3e835ad3afb5f9ed
cp %{_builddir}/dldt-2019_R3/inference-engine/thirdparty/mkl-dnn/src/cpu/xbyak/COPYRIGHT %{buildroot}/usr/share/package-licenses/dldt/59ecdb87df571ebd03bc505a75344cc6f49626e8
cp %{_builddir}/dldt-2019_R3/inference-engine/thirdparty/mkl-dnn/tests/gtests/gtest/LICENSE %{buildroot}/usr/share/package-licenses/dldt/5a2314153eadadc69258a9429104cd11804ea304
pushd inference-engine
pushd clr-build-avx512
%make_install_avx512  || :
popd
