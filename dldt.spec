...
Source2  : https://download.01.org/opencv/2019/openvinotoolkit/R1/inference_engine/firmware_ma2480_mdk_R7_9.zip
...
cd ..
%setup -q -T -D -n dldt-2019_R1.1 -b 1
cd ..
%setup -q -T -D -n dldt-2019_R1.1 -b 2
mkdir -p mvnc
cp -r %{_topdir}/BUILD/mvnc/* %{_topdir}/BUILD/dldt-2019_R1.1/mvnc
mkdir -p mvnc
cp -r %{_topdir}/BUILD/mvnc/* %{_topdir}/BUILD/dldt-2019_R1.1/mvnc
%patch1 -p1
%patch2 -p1
...
%exclude /usr/bin/haswell/benchmark_app
